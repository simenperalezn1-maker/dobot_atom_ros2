#!/usr/bin/env python3
"""
Atom W-P3 Arms-only launch (default) - Arms control only, auto-activate.
"""
...
def generate_launch_description():
    ...
    robot_name_in_model = f'atom_w_p3_arms_{timestamp}_{random_suffix}'
    ...
    return LaunchDescription([
        ...
        node_robot_state_publisher, spawn_entity, controller_manager,
